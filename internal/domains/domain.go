...
type TaxCalculator interface {
	CalculateAnnualTax(ctx context.Context, salary float64) float64
}
...
func (s *ProgressiveTaxStrategy) CalculateAnnualTax(ctx context.Context, salary float64) float64 {
	totalTax := 0.0
